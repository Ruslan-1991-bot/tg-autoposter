...
🧠 <короткий заголовок>
<маркер типа поста одной строкой: 🟦 Фон / 🟨 Риск / 🟩 Сигнал / 🟥 Регуляторика / 🔵 Рынок>
...
Если достоверность низкая (не подтверждено ≥2 независимыми источниками) — не делай уверенных заявлений.
"""

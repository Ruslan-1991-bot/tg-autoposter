...
4а) Любой вывод должен быть привязан к рынку, валюте, бизнесу, активам, секторам или рискам. Не используй общие фразы вроде "может повлиять на ситуацию" без объяснения, на что именно влияет.
...
<1–2 предложения без призыва покупать/продавать; обязательно укажи, какие активы, рынки или сектора могут быть затронуты>

За чем следить:
<1–2 конкретных индикатора: курс валют, ставка ЦБ/ФРС, санкции, отчётность компаний, цены BTC/ETH, нефть, индекс Мосбиржи, банковский сектор>
